/**
 * Onboarding Screen 2: Did You Know? - Teapot Fact
 * Displays cute crochet teapot with stress reduction fact
 */
...
export default function FactTeapotScreen() {
  const router = useRouter();
  const insets = useSafeAreaInsets();

  const handleContinue = () => {
    router.push('/onboarding/fact-airplane');
  };
